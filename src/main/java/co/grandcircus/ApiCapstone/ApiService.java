...
public class ApiService {
	...
	public List<Events> showByKeyword(String keyword) {
		...
		String url = "https://app.ticketmaster.com/discovery/v2/events?apikey=7elxdku9GGG5k8j0Xm8KWdANDgecHMV0&locale=*&keyword="
				+ keyword;
	...
	public List<Events> showByCity(String city) {
		...
		String url = "https://app.ticketmaster.com/discovery/v2/events?apikey=7elxdku9GGG5k8j0Xm8KWdANDgecHMV0&locale=*&city="
				+ city;
	...
	public List<Events> showByDate(String date) {
		...
		String url = "https://app.ticketmaster.com/discovery/v2/events?apikey=7elxdku9GGG5k8j0Xm8KWdANDgecHMV0&locale=*&startDateTime="
				+ date + "T00:00:00Z";
...
//	public Events showById(Long id) {
//		String url = "";
//		return null;
//	}
}
